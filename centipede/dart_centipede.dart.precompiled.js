...
["", "dart_centipede.dart", , G, {
  "": "",
  main: [function() {
    var canvas, centipede, t1, t2;
    canvas = document.querySelector("#myCanvas");
    canvas.focus();
    centipede = new G.Game(canvas, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
    centipede.Game$1(canvas);
    centipede.clear_screen$0();
    centipede.step$0(centipede);
    t1 = window;
    t2 = centipede.get$draw();
    C.Window_methods._ensureRequestAnimationFrame$0(t1);
    C.Window_methods._requestAnimationFrame$1(t1, W._wrapZone(t2));
  }, "call$0", "main$closure", 0, 0, 0],
  Game: {
    "": "Object;canvas,renderTime,_width,_height,mx,my,max_cells,body,current_food,game_timer,direction,game_running,game_success,head,speed,cell_size,fill,growth_rate,growth_remaining,direction_time,next_direction",
    init_var$0: function() {
      var t1, t2, t3;
      t1 = this.canvas;
      ...
      t3 = t2.get$width(t1);
      this._width = t3;
      this._height = t2.get$height(t1);
      this.cell_size = 8;
      this.speed = 100;
      if (typeof t3 !== "number")
        return t3.$div();
      t3 = C.JSInt_methods.toInt$0(t3 / 8);
      t1 = this._height;
      t2 = this.cell_size;
      if (typeof t1 !== "number")
        return t1.$div();
      if (typeof t2 !== "number")
        return H.iae(t2);
      this.max_cells = [t3, C.JSInt_methods.toInt$0(t1 / t2)];
      t2 = this._width;
      t1 = this.cell_size;
      if (typeof t2 !== "number")
        return t2.$div();
      ...
      if (typeof t3 !== "number")
        return t3.$div();
      t1 = new G.Cell(t2 / t1 / 2, t3 / t1 / 2, t1);
      this.head = t1;
      this.body = [t1];
      this.growth_rate = 4;
      this.growth_remaining = 0;
      this.direction_time = 0;
      switch (C.C__JSRandom.nextInt$1(4)) {
        case 0:
          this.direction = "North";
          this.next_direction = "North";
          break;
        case 1:
          this.direction = "South";
          this.next_direction = "South";
          break;
        case 2:
          this.direction = "East";
          this.next_direction = "East";
          break;
        default:
          this.direction = "West";
          this.next_direction = "West";
      }
      this.get_next_food$0();
      this.game_success = false;
      this.game_running = true;
    },
    mouse_movement$1: [function(e) {
      var t1, t2, t3;
      t1 = J.$add$ns(this._width, e.get$clientX());
      t2 = this.canvas;
      t3 = J.get$right$x(t2.getBoundingClientRect());
      if (typeof t1 !== "number")
        return t1.$sub();
      if (typeof t3 !== "number")
        return H.iae(t3);
      this.mx = t1 - t3;
      t3 = J.$add$ns(this._height, e.get$clientY());
      t2 = J.get$bottom$x(t2.getBoundingClientRect());
      if (typeof t3 !== "number")
        return t3.$sub();
      if (typeof t2 !== "number")
        return H.iae(t2);
      ...
      this.my = t2;
      t3 = this.mx;
      document.querySelector("#mouse").textContent = "(" + C.JSInt_methods.toInt$0(C.JSNumber_methods.toInt$0(J.roundToDouble$0$n(t3))) + "," + C.JSInt_methods.toInt$0(C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t2))) + ")";
    }, "call$1", "get$mouse_movement", 2, 0, 1],
    mouse_press$1: [function(e) {
      var context, t1, t2, t3;
      context = J.get$context2D$x(this.canvas);
      if (this.game_running !== true) {
        ...
        if (t1 > t3)
          if (t1 < t3 + t2 / 2 - 8) {
            ...
            if (typeof t1 !== "number")
              return t1.$gt();
            t1 = t1 > t3 + 8 && t1 < t3 + 4 + t2 / 4 - 16;
          } else
            t1 = false;
        else
          t1 = false;
        if (t1) {
          P.print("Button Pressed");
          t1 = this.game_success;
          t2 = this._width;
          t3 = this._height;
          if (t1 === true) {
            if (typeof t2 !== "number")
            ...
            if (typeof t3 !== "number")
              return t3.$div();
            context.clearRect(t2 / 4, t3 / 6, t2 / 2, t3 / 2);
            t1 = this._width;
            if (typeof t1 !== "number")
              return t1.$div();
            t2 = this._height;
            if (typeof t2 !== "number")
              return t2.$mul();
            context.fillRect(t1 / 4 + 4, t2 * 5 / 12 + 4, t1 / 2 - 8, t2 / 4 - 8);
            t2 = this._width;
            if (typeof t2 !== "number")
              return t2.$div();
            t1 = this._height;
            if (typeof t1 !== "number")
              return t1.$mul();
            context.clearRect(t2 / 4 + 10, t1 * 5 / 12 + 10, t2 / 2 - 20, t1 / 4 - 20);
            ...
            if (typeof t2 !== "number")
              return t2.$div();
            C.CanvasRenderingContext2D_methods.fillText$4(context, "Success", t1, t2 / 4, t1);
            ...
            if (typeof t2 !== "number")
              return t2.$div();
            C.CanvasRenderingContext2D_methods.fillText$4(context, "New Game", t1, t2 / 2 + 4, t1);
          } else {
            if (typeof t2 !== "number")
              return t2.$div();
            if (typeof t3 !== "number")
            ...
            if (typeof t2 !== "number")
              return t2.$div();
            C.CanvasRenderingContext2D_methods.fillText$4(context, "Failure", t1, t2 / 4, t1);
            context.font = "20pt Calibri";
            context.textAlign = "center";
            t1 = this._width;
            if (typeof t1 !== "number")
            ...
            if (typeof t2 !== "number")
              return t2.$div();
            C.CanvasRenderingContext2D_methods.fillText$4(context, "Restart", t1, t2 / 2 + 4, t1);
          }
        }
      }
    }, "call$1", "get$mouse_press", 2, 0, 1],
    mouse_release$1: [function(e) {
      var context, t1, t2, t3;
      context = J.get$context2D$x(this.canvas);
      if (this.game_running !== true) {
        t1 = this.mx;
        ...
        if (t1) {
          ...
          if (t1 === true) {
            ...
            if (typeof t1 !== "number")
              return t1.$mul();
            context.clearRect(t2 / 4 + 8, t1 * 5 / 12 + 8, t2 / 2 - 16, t1 / 4 - 16);
            context.font = "30pt Calibri";
            context.textAlign = "center";
            t1 = this._width;
            if (typeof t1 !== "number")
            ...
            if (typeof t2 !== "number")
              return t2.$div();
            C.CanvasRenderingContext2D_methods.fillText$4(context, "New Game", t1, t2 / 2, t1);
          } else {
            if (typeof t2 !== "number")
              return t2.$div();
            if (typeof t3 !== "number")
            ...
            if (typeof t2 !== "number")
              return t2.$div();
            C.CanvasRenderingContext2D_methods.fillText$4(context, "Restart", t1, t2 / 2, t1);
          }
          this.init_var$0();
          this.clear_screen$0();
          this.step$0(this);
    ...
    }, "call$1", "get$mouse_release", 2, 0, 1],
    key_listener$1: [function(e) {
      ...
      switch (t1.get$keyCode(e)) {
        case 37:
          ...
          break;
        case 38:
          this.change_direction$1("North");
          break;
        case 39:
          this.change_direction$1("East");
          break;
        case 40:
          this.change_direction$1("South");
          break;
        default:
      }
    }, "call$1", "get$key_listener", 2, 0, 1],
    get_next_food$0: function() {
      var t1, rnd;
      t1 = P.DateTime$_now();
      rnd = P._Random$(t1.millisecondsSinceEpoch);
      this.current_food = new G.Food(rnd.nextInt$1(this.max_cells[0]), rnd.nextInt$1(this.max_cells[1]), this.cell_size);
    },
    clear_screen$0: function() {
      var context = J.get$context2D$x(this.canvas);
      context.fillStyle = "black";
      context.fillRect(0, 0, this._width, this._height);
    },
    step$0: [function(_) {
      var t1, t2, next_position, t3, i;
      t1 = this.direction_time;
      if (typeof t1 !== "number")
        return t1.$gt();
      if (t1 > 0) {
        --t1;
        this.direction_time = t1;
      }
      if (t1 === 0) {
        t1 = this.next_direction;
        t2 = this.direction;
        t2 = t1 == null ? t2 != null : t1 !== t2;
        t1 = t2;
      } else
      ...
      next_position = new G.Cell(null, null, null);
      next_position.Cell$nextPosition$2(this.head, this.direction);
      t1 = next_position.x;
      t2 = this.max_cells;
      t3 = t2[0];
      if (typeof t1 !== "number")
      ...
      if (!(t1 > t3 - 1)) {
        ...
        if (typeof t3 !== "number")
          return t3.$gt();
        t1 = t3 > t2 - 1 || t1 < 0 || t3 < 0;
      } else
        t1 = true;
      if (t1)
        this.game_over$0();
      t1 = this.current_food;
      if (t1.compareTo$1(t1, next_position) === 0) {
        t1 = this.growth_remaining;
        t2 = this.growth_rate;
        if (typeof t1 !== "number")
          return t1.$add();
        if (typeof t2 !== "number")
          return H.iae(t2);
        this.growth_remaining = t1 + t2;
        this.get_next_food$0();
      }
      t1 = this.growth_remaining;
      if (typeof t1 !== "number")
      ...
      if (t1 < 1) {
        ...
        this.growth_remaining = t1 - 1;
      for (i = 0; t1 = this.body, i < t1.length; ++i)
        if (next_position.equal$1(t1[i]))
          this.game_over$0();
      t1.toString;
      if (typeof t1 !== "object" || t1 === null || !!t1.fixed$length)
        H.throwExpression(P.UnsupportedError$("insert"));
      t1.splice(0, 0, next_position);
      t1 = this.body;
      if (0 >= t1.length)
        return H.ioore(t1, 0);
      this.head = t1[0];
      if (this.game_running === true)
        this.game_timer = P.Timer_Timer(P.Duration$(0, 0, 0, this.speed, 0, 0), this.get$step(this));
    }, "call$0", "get$step", 0, 0, 0],
    game_over$0: function() {
      var t1, t2, line;
      t1 = "You had " + this.body.length + "/";
      t2 = this.max_cells;
      line = t1 + C.JSInt_methods.toInt$0(t2[0] * t2[1] / 2);
      H.printString(line);
      this.game_running = false;
      t1 = this.body.length;
      t2 = this.max_cells;
      t2 = t1 > t2[0] * t2[1] / 2;
      this.game_success = t2;
      t1 = this.speed;
      if (t2) {
        if (typeof t1 !== "number")
          return t1.$mul();
        this.game_timer = P.Timer_Timer(new P.Duration(0 + t1 * 1000 + 0), this.get$draw_success());
      } else {
        if (typeof t1 !== "number")
          return t1.$mul();
        this.game_timer = P.Timer_Timer(new P.Duration(0 + t1 * 1000 + 0), this.get$draw_failure());
      }
    },
    change_direction$1: function(direction) {
      var t1, t2;
      t1 = this.direction;
      if (t1 === "North" || t1 === "South")
        t2 = direction === "East" || direction === "West";
      else
        t2 = false;
      if (!t2)
        if (t1 === "East" || t1 === "West")
          t1 = direction === "North" || direction === "South";
        else
          t1 = false;
      else
        t1 = true;
      if (t1) {
        ...
        this.direction_time = 2;
      }
    },
    draw_failure$0: [function() {
      var context, t1, t2;
      context = J.get$context2D$x(this.canvas);
      t1 = this._width;
      if (typeof t1 !== "number")
      ...
      if (typeof t2 !== "number")
        return t2.$div();
      context.clearRect(t1 / 4, t2 / 6, t1 / 2, t2 / 2);
      t2 = this._width;
      if (typeof t2 !== "number")
        return t2.$div();
      t1 = this._height;
      if (typeof t1 !== "number")
        return t1.$mul();
      context.fillRect(t2 / 4 + 4, t1 * 5 / 12 + 4, t2 / 2 - 8, t1 / 4 - 8);
      t1 = this._width;
      if (typeof t1 !== "number")
        return t1.$div();
      t2 = this._height;
      if (typeof t2 !== "number")
        return t2.$mul();
      context.clearRect(t1 / 4 + 8, t2 * 5 / 12 + 8, t1 / 2 - 16, t2 / 4 - 16);
      context.font = "30pt Calibri";
      context.textAlign = "center";
      t2 = this._width;
      if (typeof t2 !== "number")
      ...
      if (typeof t1 !== "number")
        return t1.$div();
      C.CanvasRenderingContext2D_methods.fillText$4(context, "Failure", t2, t1 / 4, t2);
      context.font = "20pt Calibri";
      context.textAlign = "center";
      t2 = this._width;
      if (typeof t2 !== "number")
      ...
      if (typeof t1 !== "number")
        return t1.$div();
      C.CanvasRenderingContext2D_methods.fillText$4(context, "Restart", t2, t1 / 2, t2);
    }, "call$0", "get$draw_failure", 0, 0, 0],
    draw_success$0: [function() {
      var context, t1, t2;
      context = J.get$context2D$x(this.canvas);
      t1 = this._width;
      if (typeof t1 !== "number")
      ...
      if (typeof t1 !== "number")
        return t1.$div();
      C.CanvasRenderingContext2D_methods.fillText$4(context, "Success", t2, t1 / 4, t2);
      context.font = "20pt Calibri";
      context.textAlign = "center";
      t2 = this._width;
      if (typeof t2 !== "number")
      ...
      if (typeof t1 !== "number")
        return t1.$div();
      C.CanvasRenderingContext2D_methods.fillText$4(context, "New Game", t2, t1 / 2, t2);
    }, "call$0", "get$draw_success", 0, 0, 0],
    draw$1: [function(_) {
      var context, time, t1, t2, i;
      context = J.get$context2D$x(this.canvas);
      ...
      if (t1 != null) {
        if (typeof t1 !== "number")
          return H.iae(t1);
        t1 = C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(1000 / (time - t1)));
        t2 = $.fpsAverage;
        if (t2 == null) {
          $.fpsAverage = t1;
          t2 = t1;
      ...
      this.clear_screen$0();
      this.current_food.draw$1(context);
      for (i = 0; t1 = this.body, i < t1.length; ++i)
        t1[i].draw$1(context);
      if (this.game_running === true) {
        t1 = window;
    ...
    Game$1: function(canvas) {
      ...
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._html$_target, t2._eventType, W._wrapZone(this.get$key_listener()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t1, C.EventStreamProvider_mousemove._eventType, false), [null]);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._html$_target, t2._eventType, W._wrapZone(this.get$mouse_movement()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t1, C.EventStreamProvider_mousedown._eventType, false), [null]);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._html$_target, t2._eventType, W._wrapZone(this.get$mouse_press()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t1, C.EventStreamProvider_mouseup._eventType, false), [null]);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(this.get$mouse_release()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      this.init_var$0();
    }
  },
  Cell: {
    "": "Object;x,y,body_size",
    draw$1: function(context) {
      ...
      if (t4)
        return;
      context.clearRect(t1 * t2, t3 * t2, t2, t2);
    },
    ...
    Cell$nextPosition$2: function(current, direction) {
      var t1;
  ...
  Food: {
    ...
    draw$1: function(context) {
      ...
      if (typeof t2 !== "number")
        return H.iae(t2);
      t3 = t2 / 2;
      context.arc(t1 * t2 + t3, this.y * t2 + t3, t3, 0, 6.283185307179586, false);
      context.closePath();
      context.clip();
      t3 = this.x;
      t2 = this.body_size;
      if (typeof t2 !== "number")
        return H.iae(t2);
      context.clearRect(t3 * t2, this.y * t2, t2, t2);
      context.restore();
    }
  }
},
...
function dart_precompiled($collectedClasses) {
  ...
  function Game(canvas, renderTime, _width, _height, mx, my, max_cells, body, current_food, game_timer, direction, game_running, game_success, head, speed, cell_size, fill, growth_rate, growth_remaining, direction_time, next_direction) {
    this.canvas = canvas;
    ...
    this.growth_remaining = growth_remaining;
